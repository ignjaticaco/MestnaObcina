			...
			<div class="row">
				...
				<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
	            	...
	            	<p class="fh5co-property-specification">
	            		<span><strong><?php echo $row['velikost']; ?></strong> Sq Ft</span>  <span><strong>3</strong> Beds</span>  <span><strong>3.5</strong> Baths</span>  <span><strong>2</strong> Garages</span>
	            	</p>
					</div>
				</div>
 <?php }?>
